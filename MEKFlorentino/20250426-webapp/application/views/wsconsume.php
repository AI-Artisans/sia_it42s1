...
<body>
    <div class="weather-container">
        <h2 id="location"><?php echo $weatherData['location']['name'] . ", " .  $weatherData['location']['country']; ?>
        </h2>
        ...
        <p><strong>Temperature:</strong> <span
                id="temperature"><?php echo $weatherData['current']['temperature']; ?></span>°C</p>
        ...
        <p><strong>Wind:</strong> <span id="wind"><?php echo  
				$weatherData['current']['wind_speed']; ?></span> km/h (<span
                id="wind-dir"><?php echo $weatherData['current']['wind_dir']; ?></span>)</p>
    </div>
</body>
